    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
            ...
            <div className="p-8">
              ...
              {allSeasons.length > 0 && (
                <div className="mt-8 pt-8 border-t border-gray-600">
                  <h3 className="text-lg font-semibold text-white mb-4">Season Management</h3>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-400">
                        Switching seasons will change which members and data are displayed throughout the app.
                      </p>
                    </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-xl border border-gray-700 overflow-hidden">
            <div className="px-8 py-6 border-b border-gray-700 bg-gradient-to-r from-blue-900/50 to-gray-800">
              <h2 className="text-2xl font-semibold text-white">Import History</h2>
              <p className="text-gray-300 mt-1">View recent data import operations</p>
            </div>
            <div className="p-8">
              <ImportHistory />
            </div>
